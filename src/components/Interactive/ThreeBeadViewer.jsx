      ...
      <div className="bead-specs-box">
        ...
        {inquirySent ? (
          <div style={{
            ...
            <p style={{ color: 'var(--gold-lt)', fontWeight: '600', fontSize: '13px', marginBottom: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M20 6L9 17l-5-5" /></svg> Inquiry Submitted!
            </p>
            <p style={{ color: 'rgba(255,253,248,0.8)', fontSize: '11.5px', margin: 0 }}>
              Our senior curators will reach out via WhatsApp/Email shortly to assist you.
            </p>
            <button 
              onClick={() => setInquirySent(false)} 
              style={{ background: 'transparent', border: 'none', color: 'rgba(255,253,248,0.5)', fontSize: '10px', textDecoration: 'underline', marginTop: '8px', cursor: 'pointer' }}
            >
              Back to inquiry
            </button>
          </div>
          ...
          <div className="bead-action-row">
            <button className="btn-gold-sm" onClick={() => setInquirySent(true)}>Inquire Availability</button>
