  ...
  useEffect(() => {
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      if (colorVal < 0.15) {
        ...
        // Bright Gold/Amber
        r = 0.78; g = 0.61; b = 0.25;
      } else if (colorVal < 0.92) {
        // Warm Terracotta/Teak Wood
        r = 0.55; g = 0.40; b = 0.22;
      } else {
        // Warm Mid-Teak (Instead of Deep blackish teak to avoid empty spaces)
